...
class ModelGeomTest(TestCase):
    def setUp(self):
        self.fenomeno = Fenomeno.objects.create(
            nome="Arvore", data="2020-11-06", hora="09:30:00"
        )
...
class FenomenoFormValidatorsTest(TestCase):
    ...
    def test_max_longitude_raises_error(self):
        ...
        self.assertEqual(
            ...
            "Coordenada longitude fora do contexto do estado do Rio de Janeiro",
        )
    ...
    def test_max_latitude_raises_error(self):
        ...
        self.assertEqual(
            ...
            "Coordenada latitude fora do contexto do estado do Rio de Janeiro",
        )
